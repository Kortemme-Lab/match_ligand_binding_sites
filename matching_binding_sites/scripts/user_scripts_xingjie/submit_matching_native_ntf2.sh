...
cp -r scaffolds/native_ntf2_scaffolds ${TMPDIR}

./scripts/user_scripts_xingjie/match_binding_sites_to_scaffolds.py ${TMPDIR}/native_ntf2_scaffolds matching_3res_site_to_native_ntf2_no_dump/ ${SGE_TASK_ID} -n 3

./scripts/user_scripts_xingjie/match_binding_sites_to_scaffolds.py ${TMPDIR}/native_ntf2_scaffolds matching_site_to_native_ntf2_no_dump/ ${SGE_TASK_ID}
